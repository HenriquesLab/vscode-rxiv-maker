...
"""
        ...
        assert r"\citation{test2023}" in aux_content, \
            "Citation not found in aux file"
    ...
    def test_citation_in_generated_tex(self, tmp_path):
        ...
        test_cases = [
            ...
            ("Multiple: [@test2023;@another2023].", r"Multiple: \cite{test2023,another2023}."),
...
class TestCitationProcessingIntegration:
    ...
    def test_example_manuscript_citations_resolved(self):
        ...
        for citation in important_citations:
            assert f"@" in bib_content and citation in bib_content, \
