...
try:
    ...
    from src.py.validators.base_validator import ValidationLevel, ValidationError
...
class TestDOIValidator(unittest.TestCase):
    ...
    def test_doi_format_validation(self):
        ...
        validator = DOIValidator(self.manuscript_dir, enable_online_validation=False, cache_dir=self.cache_dir)
...
"""
    ...
    def test_metadata_comparison_edge_cases(self):
        ...
        errors = validator._compare_metadata(bib_entry, crossref_metadata, "test.bib", 1)
    ...
    def test_similarity_threshold(self):
        ...
        similarity = SequenceMatcher(None, 
                                   validator._clean_title(title1), 
                                   validator._clean_title(title2)).ratio()
        ...
        similarity2 = SequenceMatcher(None, 
                                    validator._clean_title(title1), 
                                    validator._clean_title(title3)).ratio()
