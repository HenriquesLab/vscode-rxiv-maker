...
class TestFigureGeneratorCore(unittest.TestCase):
    ...
    def test_figure_generator_initialization(self):
        ...
        class MockFigureGenerator:
            def __init__(self, figures_dir="FIGURES", output_dir="FIGURES", 
                        output_format="png", r_only=False):
...
'''
    ...
    def test_r_script_execution_failure(self, mock_run):
        ...
        mock_run.return_value = Mock(
            returncode=1, 
            stderr="Error: object 'linewidth' not found"
        )
...
'''
    ...
    def test_mermaid_cli_execution_simulation(self, mock_run):
        ...
        mock_run.return_value = Mock(returncode=0, stdout="Diagram generated successfully")
    ...
    def test_mermaid_docker_fallback(self, mock_run):
        ...
        mock_run.side_effect = [
            ...
            Mock(returncode=0, stdout="Docker diagram generated")   # Docker fallback works
        ]
        ...
        docker_result = subprocess.run([
            ...
            "-i", "/workspace/test_diagram.mmd",
            "-o", "/workspace/test_diagram.svg"
