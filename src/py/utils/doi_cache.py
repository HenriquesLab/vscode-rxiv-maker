...
class DOICache:
    ...
    def __init__(self, cache_dir: str = ".cache", cache_filename: str = "doi_cache.json"):
    ...
    def set_resolution_status(self, doi: str, resolves: bool, error_message: str = None) -> None:
