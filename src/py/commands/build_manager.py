...
class BuildManager:
    ...
    def __init__(self, manuscript_path: str = None, output_dir: str = "output", 
                 force_figures: bool = False, skip_validation: bool = False,
                 verbose: bool = False):
    ...
    def run_full_build(self) -> bool:
        ...
        self.log(f"Starting build process for manuscript: {self.manuscript_path}", "STEP")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Build manager for Rxiv-Maker"
    )
    parser.add_argument(
        "--manuscript-path",
        default=None,
    ...
    parser.add_argument(
        "--skip-validation",
        action="store_true",
        help="Skip manuscript validation"
    )
    parser.add_argument(
        "--verbose",
        "-v",
